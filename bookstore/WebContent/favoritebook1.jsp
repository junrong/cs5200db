			...
			<div class="col-md-12">
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li><a class="menu-top-active" href="favoritebook1.jsp?username=<%=username%>">FavoriteBook</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-head-line">The Book You liked ~</h4>
										...
										<form name="formname1" action="viewmore.jsp" style="clear:both; margin-bottom: 50px;">
