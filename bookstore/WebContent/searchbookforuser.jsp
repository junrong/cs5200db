			...
			<div class="col-md-12">
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						<li><a class="menu-top-active" href="searchbookforuser.jsp?username=<%=username%>">Search</a></li>
						...
						<li><a href="userprofile1.jsp?username=<%=username%>">View Profile</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p>Welcome to my bookstore! You will find whatever you want
						from here!</p>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<input type="hidden" id="current_user_id" name="username"
						value="<%=userId%>"></input>

						<form action="AccessServlet">
						<button class="btn btn-info" id="username" name="username" value="<%=username%>">About
							me</button>
