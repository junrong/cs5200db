				...
				<div class="col-md-12">
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a class="menu-top-active" href="createbook.jsp?username=<%=username%>">ManagementBook</a></li>
							...
							<input type="hidden" name="username" value="<%=username%>"/>
								<div id="add">
									...
									<table>
										...
										<tr>
											<td>&nbsp;</td>
											<td><button name="action" value="add">Add to Database</button></td>
										</tr>
									</table>
								</div>
							</form>
