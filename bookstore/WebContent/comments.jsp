...
<!-- ==============content====================== -->
	...
	<form action="likeServlet">
		...
		<input type="hidden" name="bookTitle" id="bookTitle"> <input
			type="hidden" name="bookAuthor" id="bookAuthor"> <input
			type="hidden" name="bookImgurl" id="bookImgurl"> <input
			type="hidden" name="bookCategory" id="bookCategory"> <input
...
function init() {
	...
	var bookid = "<%=book.getBookId()%>";
			...
			function handleResponse(book) {
				...
				var liStr = '<tr id="1234"><td><img height="166" src=""/><button name="action" value="like" class="">Like</button></td></tr>'
